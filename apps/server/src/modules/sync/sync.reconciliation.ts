...
import { FileVersion, Vault } from "./sync.models.js";
import { readFileAtHead } from "./sync.git-storage.js";
import { splitAndHash, hashChunk, type ChunkRecord } from "./sync.chunk-differ.js";
...
export async function reconcileVault(vaultId: string): Promise<{
  ...
  for (const version of versions) {
    ...
    if (missing.length > 0) {
      ...
      version.chunks = updatedRecords as typeof version.chunks;
