...
export function CommandPalette({ open, onClose, onSelectFile, onAskVault }: CommandPaletteProps) {
                ...
                {results.map((r) => (
                  ...
                  >
                    <div className="nv-result-head">
                      ...
                      {r.score > 0 && (
                        <span className="nv-result-score">{(r.score * 100).toFixed(0)}%</span>
                      )}
                    </div>
                    {r.payload.text && (
    ...
    <>
      <div className="nv-modal-section">
        ...
        <ul className="nv-ops">
          <li>
            <code>!keyword:</code>
            <span>exact match in chunk text</span>
            <kbd>BM25</kbd>
          </li>
          <li>
            <code>!semantic:</code>
            <span>vector similarity only</span>
            <kbd>cosine</kbd>
          </li>
          <li>
            <code>!file:</code>
          ...
          <li>
            <code>(none)</code>
            <span>hybrid · merged via reciprocal rank fusion</span>
            <kbd>default</kbd>
          </li>
        </ul>
      </div>
